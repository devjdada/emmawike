...
export function useImageUploadButton(editor: Editor | null, extensionName: string = 'imageUpload', disabled: boolean = false) {
...
export const ImageUploadButton = React.forwardRef<HTMLButtonElement, ImageUploadButtonProps>(
    ({ editor: providedEditor, extensionName = 'imageUpload', text, className = '', disabled, onClick, children, ...buttonProps }, ref) => {
        ...
        if (!editor?.editor || !editor.editor.isEditable) {
            return null;
        }
