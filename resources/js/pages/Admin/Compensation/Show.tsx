...
}: CompensationShowProps) {
	const [compensation, setCompensation] =
		useState<Compensation>(initialCompensation);
	const { toast } = useToast();
	const { delete: inertiaDelete } = useForm();

	const [isValuationModalOpen, setIsValuationModalOpen] = useState(false);
	const [editingValuation, setEditingValuation] = useState<Valuation | null>(
		null,
	);
	...
	return (
		<AppLayout user={auth.user}>
			...
			<div className="container mx-auto py-8 px-4">
				<div className="flex justify-between items-center mb-8">
					<div>
						<h1 className="text-3xl font-bold text-foreground">
							Compensation Details: {compensation.code}
						</h1>
						<p className="text-muted-foreground">
							Detailed view of compensation record and its associated
							valuations.
						</p>
					</div>
				...
				<Card className="mb-8">
					...
					<CardContent className="grid grid-cols-1 md:grid-cols-3 gap-4">
						...
						<div>
							...
							<p className="text-lg">
								{formatCurrency(Number(compensation.total_value))}
							</p>
						</div>
						<div>
						...
						<div>
							...
							<p className="text-lg">
								{format(
									new Date(compensation.created_at),
									"MMM dd, yyyy HH:mm",
								)}
							</p>
						</div>
						<div>
							...
							<p className="text-lg">
								{format(
									new Date(compensation.updated_at),
									"MMM dd, yyyy HH:mm",
								)}
							</p>
						</div>
				...
				<div className="mt-8 grid grid-cols-3 max-sm:col-cols-1 gap-4">
											...
											<CardContent>
												<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
													...
													<div>
														...
														<p className="text-lg">
															{valuation.market_price_per_unit || "N/A"}
														</p>
													</div>
													<div>
														<p className="text-xs text-gray-300 font-medium">
											...
											<CardContent>
												<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
													...
													<div>
														...
														<p className="text-lg">
															{valuation.manufacture_year || "N/A"}
														</p>
													</div>
													<div>
														<p className="text-sm font-medium">
														...
														<p className="text-lg">
															{formatCurrency(
																Number(valuation.current_value),
															) || "N/A"}
														</p>
													</div>
													<div>
											...
											<CardContent>
												<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
													<div>
														...
														<p className="text-lg">
															{valuation.land_use_type || "N/A"}
														</p>
													</div>
													<div>
														<p className="text-sm font-medium">Area (sqft):</p>
														<p className="text-lg">
															{valuation.area_sqft || "N/A"}
														</p>
													</div>
													<div>
														<p className="text-sm font-medium">
													...
													<div>
														...
														<p className="text-lg">
															{valuation.zoning_regulations || "N/A"}
														</p>
													</div>
													<div>
														<p className="text-sm font-medium">Soil Quality:</p>
														<p className="text-lg">
															{valuation.soil_quality || "N/A"}
														</p>
													</div>
													<div>
														<p className="text-sm font-medium">
											...
											<CardContent>
												<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
													...
													<div>
														...
														<p className="text-lg">
															{valuation.construction_year || "N/A"}
														</p>
													</div>
													<div>
														<p className="text-sm font-medium">Condition:</p>
														<p className="text-lg">
															{valuation.condition || "N/A"}
														</p>
													</div>
													<div>
														<p className="text-sm font-medium">
														...
														<p className="text-lg">
															{formatCurrency(
																Number(valuation.renovation_cost),
															) || "N/A"}
														</p>
													</div>
													<div>
													...
													<div>
														...
														<p className="text-lg">
															{formatCurrency(
																Number(valuation.complete_amount),
															) || "N/A"}
														</p>
													</div>
												</div>
