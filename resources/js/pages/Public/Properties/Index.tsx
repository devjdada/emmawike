...
export default function PropertiesIndex({ properties }: PropertiesIndexProps) {
    return (
        <PublicLayout>
            ...
            {/* Hero Section */}
            <section className="bg-gradient-to-br from-primary/5 to-accent/5 pt-24 pb-12">
                            ...
                            >
                                <Card className="group overflow-hidden transition-all duration-300 hover:shadow-xl">
                                    <div className="relative">
                                        <img
                                            src={property.media[0] ? `/storage/${property.media[0].path}` : 'https://via.placeholder.com/600x400'}
                                            alt={property.title}
                                            className="h-64 w-full object-cover transition-transform duration-300 group-hover:scale-105"
                                        />
                                        {property.is_featured && <Badge className="absolute top-4 left-4 bg-accent text-white">Featured</Badge>}
                                    ...
                                    <CardContent className="p-6">
                                        <div className="mb-4">
                                            <h3 className="mb-2 text-xl font-semibold text-foreground">{property.title}</h3>
