...
import { Building, DollarSign, Download, Edit, Eye, Hammer, MapPin, MoreHorizontal, Plus, Search, Star, Trash2, Upload, Users } from 'lucide-react';
                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-8 grid grid-cols-1 gap-6 md:grid-cols-4">
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div className="text-2xl font-bold">{filteredProjects.filter((p) => p.status === 'in progress').length}</div>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div className="text-2xl font-bold">
                                    ${filteredProjects.reduce((total, project) => total + (project.budget || 0), 0).toLocaleString()}
                                </div>
