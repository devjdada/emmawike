...
export default function RentAgreementsIndex({
	auth,
	rentAgreements: initialRentAgreements,
}: RentAgreementsIndexProps) {
	...
	const confirmDelete = () => {
		if (selectedAgreement) {
			inertiaDelete(
				route("admin.rent-agreements.destroy", selectedAgreement.id),
				{
					onSuccess: () => {
						toast({
							title: "Agreement Deleted",
							description: "The rent agreement has been removed.",
						});
				...
				<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
					...
					<div className="mb-8 flex items-center justify-between">
						...
						<div className="flex items-center gap-2">
							...
							<Button asChild>
								<Link href={route("admin.rent-agreements.create")}>
					...
					<div>
						<div className="p-4">
							<h2 className="text-xl font-semibold">
								Agreements ({initialRentAgreements.length})
							</h2>
						</div>
						<div>
							<Table>
				...
				<DialogContent>
					<DialogHeader>
						...
						<DialogDescription>
							...
							rent agreement for ID "{selectedAgreement?.id}".
						</DialogDescription>
					</DialogHeader>
