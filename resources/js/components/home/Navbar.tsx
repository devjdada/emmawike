...
const Navbar = () => {
    ...
    return (
        <nav className="fixed top-0 right-0 left-0 z-50 border-b border-border bg-white/95 shadow-sm backdrop-blur-sm">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="flex h-20 items-center justify-between">
                    ...
                    <Link to="/" className="flex items-center space-x-3">
                        ...
                        {/* </div> */}
                        <div>
                            <h1 className="text-xl font-bold text-primary">Emma Wilke & Partners</h1>
                            ...
                            <DropdownMenuTrigger asChild>
                                <Button
                                    ...
                                    className={`flex items-center space-x-1 text-sm font-medium transition-colors hover:text-primary ${
                                        aboutMenuItems.some((item) => location.pathname === item.path) ? 'text-primary' : 'text-foreground'
                                    }`}
                                >
                                    <span>About</span>
