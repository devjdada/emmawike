...
export default function CreateEditValuationModal({
	open,
	onOpenChange,
	editingValuation,
	compensationId,
}: CreateEditValuationModalProps) {
		...
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto">
				<DialogHeader>
					...
					<DialogDescription>
						{editingValuation
							? "Make changes to the valuation record here."
							: "Fill in the details to create a new valuation record."}
					</DialogDescription>
				</DialogHeader>
				<form onSubmit={onSubmit} className="grid gap-4 py-4">
					<div className="grid grid-cols-4 items-center gap-4">
						<Label htmlFor="evaluation_type" className="text-right col-span-4">
							Evaluation Type
						</Label>
						<Select
					...
					{data.evaluation_type === "crop" && (
						<>
							...
							<div className="grid grid-cols-4 items-center gap-4">
								<Label htmlFor="crop_type" className="text-right col-span-4">
									Crop Type
								</Label>
								<Input
									id="crop_type"
							...
							<div className="grid grid-cols-3 gap-4">
								{/* Rate */}
								<div className="grid grid-cols-4 items-center gap-4">
									<Label htmlFor="rate" className="text-right col-span-4">
										Rate
									</Label>
									<Input
										id="rate"
										...
										onChange={(e) => {
											...
											setData(
												"value",
												(isNaN(parseFloat(data.yield_per_acre))
													? 0
													: parseFloat(data.yield_per_acre)) *
								...
								<div className="grid grid-cols-4 items-center gap-4">
									...
									<Input
										...
										onChange={(e) => {
											...
											setData(
												"value",
												(isNaN(parseFloat(data.rate))
													? 0
													: parseFloat(data.rate)) *
													(isNaN(newYield) ? 0 : newYield),
											);
										}}
										className="col-span-4"
									/>
									{errors.yield_per_acre && (
										<p className="col-span-4 text-right text-red-500 text-xs">
											{errors.yield_per_acre}
										</p>
									)}
					...
					{data.evaluation_type === "machine" && (
						<>
							...
							<div className="grid grid-cols-4 items-center gap-4">
								<Label htmlFor="machine_type" className="text-right col-span-4">
									Machine Type
								</Label>
								<Input
									id="machine_type"
							...
							<div className="grid grid-cols-4 items-center gap-4">
								<Label htmlFor="model" className="text-right col-span-4">
									Model
								</Label>
								<Input
									id="model"
							...
							<div className="grid grid-cols-4 items-center gap-4">
								...
								<Input
									...
									onChange={(e) =>
										setData("manufacture_year", parseInt(e.target.value))
									}
									className="col-span-4"
								/>
						...
						<>
							...
							<div className="grid grid-cols-3 gap-4">
								<div className="grid grid-cols-2 items-center gap-4">
									<Label htmlFor="length" className="text-right col-span-4">
										length (M)
									</Label>
									<Input
										id="length"
								...
								<div className="grid grid-cols-2 items-center gap-4">
									<Label htmlFor="width" className="text-right col-span-4">
										Width (M)
									</Label>
									<Input
										id="width"
								...
								<div className="grid grid-cols-4 items-center gap-4">
									<Label htmlFor="area_sqft" className="text-right col-span-4">
										Area (SqFt)
									</Label>
									<Input
										id="area_sqft"
					...
					{data.evaluation_type === "property" && (
						<>
							...
							<div className="grid grid-cols-3 gap-4">
								...
								<div className="grid grid-cols-4 items-center gap-4">
									<Label htmlFor="condition" className="text-right col-span-4">
										Condition
									</Label>
									<Input
										id="condition"
								...
								<div className="grid grid-cols-4 items-center gap-4">
									<Label htmlFor="value" className="text-right col-span-4">
										Depreciated Value
									</Label>
									<Input
										id="value"
