                            ...
                            <form onSubmit={onSubmit} className="space-y-6">
                                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                    ...
                                    <div>
                                        ...
                                        <Select onValueChange={(value) => setData('category', value)} value={data.category.toString()}>
                                            <SelectTrigger>
                                    ...
                                    <div>
                                        ...
                                        />
                                        {errors.read_time && <FormMessage>{errors.read_time}</FormMessage>}
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    {errors.featured_image && <FormMessage>{errors.featured_image}</FormMessage>}
                                    {imagePreview && (
                                        <div className="mt-4">
