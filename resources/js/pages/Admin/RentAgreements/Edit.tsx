...
export default function EditRentAgreement({
	auth,
	rentAgreement: initialRentAgreement,
}: EditRentAgreementProps) {
	...
	const submit = (e: React.FormEvent) => {
		e.preventDefault();
		put(route("admin.rent-agreements.update", initialRentAgreement.id), {
			onSuccess: () => {
				toast({
					title: "Agreement Updated",
					description: "The rent agreement has been successfully updated.",
				});
			},
			onError: () => {
				toast({
	...
	return (
		<AppLayout user={auth.user}>
			...
			<div className="mx-auto max-w-4xl p-4 sm:p-6 lg:p-8">
				<h1 className="mb-6 text-2xl font-semibold">Edit Rent Agreement</h1>
