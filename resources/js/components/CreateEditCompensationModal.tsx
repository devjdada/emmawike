...
export default function CreateEditCompensationModal({ open, onOpenChange, editingCompensation }: CreateEditCompensationModalProps) {
            ...
            <DialogContent className="sm:max-w-[600px]">
                ...
                <form onSubmit={onSubmit} className="grid gap-4 py-4">
                    <div className="grid grid-cols-4 items-center gap-4">
                        ...
                        {errors.name && <p className="col-span-4 text-right text-xs text-red-500">{errors.name}</p>}
                    </div>
                    <div className="grid grid-cols-4 items-center gap-4">
                        ...
                        {errors.email && <p className="col-span-4 text-right text-xs text-red-500">{errors.email}</p>}
                    </div>
                    <div className="grid grid-cols-4 items-center gap-4">
                        ...
                        {errors.phone && <p className="col-span-4 text-right text-xs text-red-500">{errors.phone}</p>}
                    </div>
                    <div className="grid grid-cols-4 items-center gap-4">
                        ...
                        {errors.code && <p className="col-span-4 text-right text-xs text-red-500">{errors.code}</p>}
                    </div>
                    <div className="grid grid-cols-4 items-center gap-4">
                        ...
                        />
                        {errors.total_value && <p className="col-span-4 text-right text-xs text-red-500">{errors.total_value}</p>}
                    </div>
                    <div className="grid grid-cols-4 items-center gap-4">
                        ...
                        {errors.status && <p className="col-span-4 text-right text-xs text-red-500">{errors.status}</p>}
                    </div>
                    <div className="grid grid-cols-4 items-center gap-4">
                        <Label htmlFor="notes" className="text-right">
                            Notes
                        </Label>
                        <Textarea id="notes" value={data.notes} onChange={(e) => setData('notes', e.target.value)} className="col-span-3" />
                        {errors.notes && <p className="col-span-4 text-right text-xs text-red-500">{errors.notes}</p>}
                    </div>
                    <DialogFooter>
