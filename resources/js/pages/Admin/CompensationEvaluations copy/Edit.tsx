...
export default function EditCompensationEvaluation({
	auth,
	evaluation: initialEvaluation,
	can,
}: EditCompensationEvaluationProps) {
	const { toast } = useToast();
	const [evaluationType, setEvaluationType] = useState(
		initialEvaluation.evaluation_type,
	);
	...
	const { data, setData, put, processing, errors, reset } = useForm({
		...
		market_price_per_unit:
			initialEvaluation.evaluatable?.market_price_per_unit || "",
		...
		location_description:
			initialEvaluation.evaluatable?.location_description || "",
	...
	const submit = (e: React.FormEvent) => {
		e.preventDefault();
		put(route("admin.compensation-evaluations.update", initialEvaluation.id), {
			onSuccess: () => {
				toast({
					title: "Evaluation Updated",
					description:
						"The compensation evaluation has been successfully updated.",
				});
			},
			onError: () => {
				toast({
					...
					<div className="grid grid-cols-1 gap-4 md:grid-cols-2">
						...
						<div>
							...
							<Input
								...
								onChange={(e) =>
									setData("yield_per_acre", parseFloat(e.target.value))
								}
								required
							/>
						...
						<div>
							<Label htmlFor="market_price_per_unit">
							...
							<Input
								...
								onChange={(e) =>
									setData("market_price_per_unit", parseFloat(e.target.value))
								}
								required
							/>
							<InputError
								message={errors.market_price_per_unit}
								className="mt-2"
							/>
						</div>
						<div>
							...
							<Input
								...
								onChange={(e) =>
									setData("damage_percentage", parseFloat(e.target.value))
								}
							/>
					...
					<div className="grid grid-cols-1 gap-4 md:grid-cols-2">
						...
						<div>
							...
							<Input
								...
								onChange={(e) =>
									setData("depreciation_rate", parseFloat(e.target.value))
								}
								required
							/>
				...
				return (
					<div className="grid grid-cols-1 gap-4 md:grid-cols-2">
						<div>
							...
							<Select
								onValueChange={(value) => setData("land_use_type", value)}
						...
						<div>
							...
							/>
							<InputError
								message={errors.location_description}
								className="mt-2"
							/>
						</div>
						<div>
							...
							/>
							<InputError
								message={errors.zoning_regulations}
								className="mt-2"
							/>
						</div>
						<div>
					...
					<div className="grid grid-cols-1 gap-4 md:grid-cols-2">
						...
						<div>
							...
							<Input
								...
								onChange={(e) =>
									setData("number_of_units", parseInt(e.target.value))
								}
							/>
						...
						<div>
							...
							<Input
								...
								onChange={(e) =>
									setData("construction_year", parseInt(e.target.value))
								}
								required
							/>
						...
						<div>
							...
							<Input
								...
								onChange={(e) =>
									setData("renovation_cost", parseFloat(e.target.value))
								}
							/>
						...
						<>
							<div>
								...
								<Input
									...
									onChange={(e) =>
										setData("total_value", parseFloat(e.target.value))
									}
								/>
							...
							<div>
								...
								<Select
									...
									value={data.status}
									disabled={!can.publish && data.status !== "draft"}
								>
									<SelectTrigger className="w-full">
