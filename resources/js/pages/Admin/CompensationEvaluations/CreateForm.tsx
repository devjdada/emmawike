...
export default function CreateCompensationEvaluationForm({
	auth,
	can,
}: CreateCompensationEvaluationFormProps) {
		...
		post(route("admin.compensation-evaluations.store"), {
			onSuccess: () => {
				toast({
					...
					description:
						"The compensation evaluation has been successfully created.",
				});
				reset();
				setEvaluationType("");
			},
					...
					<div className="grid grid-cols-1 gap-4 md:grid-cols-2">
						...
						<div>
							...
							<Input
								...
								onChange={(e) =>
									setData("market_price_per_unit", e.target.value)
								}
								required
							/>
							<InputError
