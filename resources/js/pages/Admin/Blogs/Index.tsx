...
import {
	...
	Trash2,
	Users,
} from "lucide-react"; // Added BookOpen, Eye, Users, Tag
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
					...
					<Card>
						...
						<CardContent>
							<div className="text-2xl font-bold">
								{
									filteredBlogs.filter((blog) => blog.status === "published")
										.length
								}
							</div>
					...
					<Card>
						<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
							...
							{/* Using Users as a placeholder for a "time" icon */}
						</CardHeader>
						<CardContent>
							<div className="text-2xl font-bold">
								{filteredBlogs.reduce(
									(sum, blog) => sum + (blog.read_time || 0),
									0,
								)}{" "}
								min
							</div>
